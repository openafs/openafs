...
#  define sys_arm_darwin_270          1

#  define SYS_NAME                    "arm_darwin_270"
#  define SYS_NAME_ID                 SYS_NAME_ID_arm_darwin_270
