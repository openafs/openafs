...
#define		KRB5_PORT		88	/* PC's don't have /etc/services */
...
/* EXP errors are:   Principal expired, Service expired, Auth expired,
 * but are not currently used much */
