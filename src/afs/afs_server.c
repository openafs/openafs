...
#if (! defined(AFS_SUN5_ENV)) && (! defined(AFS_DARWIN60_ENV)) && (! defined(AFS_OBSD47_ENV)) && defined(USEIFADDR)
void
...
#if (defined(AFS_DARWIN60_ENV) || defined(AFS_OBSD47_ENV)) && defined(USEIFADDR)
#ifndef afs_min
#define afs_min(A,B) ((A)<(B)) ? (A) : (B)
#endif
void
