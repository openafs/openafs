...
/* static prototypes */
osi_static int
osi_trace_consumer_probe_info_cache_ctor(void * buf, void * sdata, int flags);
osi_static void
osi_trace_consumer_probe_info_cache_dtor(void * buf, void * sdata);
...
osi_trace_consumer_probe_info_cache_ctor(void * buf, void * sdata, int flags)
{
    ...
    probe->probe_cache_index = *((osi_uint8 *)sdata);
