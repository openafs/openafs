...
osi_extern osi_result
osi_trace_consumer_probe_val_cache_event_subscribe(osi_trace_consumer_probe_val_cache_t *,
						   osi_event_subscription_t *);

OSI_INIT_FUNC_PROTOTYPE(osi_trace_consumer_probe_val_cache_PkgInit);
OSI_FINI_FUNC_PROTOTYPE(osi_trace_consumer_probe_val_cache_PkgShutdown);
