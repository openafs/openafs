...
#elif defined(OSI_KERNELSPACE_ENV) || defined(OSI_TRACE_BUFFER_USERSPACE)
...
#if defined(OSI_IMPLEMENTS_MEM_LOCAL) && ((defined(OSI_KERNELSPACE_ENV) && defined(OSI_IMPLEMENTS_THREAD_BIND)) || defined(OSI_USERSPACE_ENV)) && !defined(OSI_TRACE_DISABLE_CTX_LOCAL_BUFFER)
