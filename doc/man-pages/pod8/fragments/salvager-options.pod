...
Records in the F<{{ afslogsdir }}/SalvageLog> file a list of all AFS inodes
...
to the F<{{ afslogsdir }}/SalvageLog> file.
...
Records in the F<{{ afslogsdir }}/SalvageLog> file all mount points found in
